...
export const CalculatorLayout = ({ display, keypad, bottomNavigation }) => {
  ...
  const layoutClasses = oneHandMode
    ...
    : "w-full max-w-[420px] mx-auto flex flex-col bg-white dark:bg-dark-bg transition-colors duration-300 shadow-2xl relative select-none";
  ...
  return (
    ...
    >
      ...
      {/* THIS is the key fix: overflow-y-auto here, not overflow-hidden */}
      <div className="flex-1 relative overflow-y-auto px-6 pb-2 mt-2">
        {keypad}
      </div>
